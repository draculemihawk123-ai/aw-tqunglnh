...
// `worker`, `doctor`, `definition` and `evidence` subcommands. Only
// `evidence` may depend on internal/spikeacceptance-adjacent packages; every
// other subcommand's implementation must come from internal/app and
...
// regression gate (00-roadmap.md §5B).
package main
