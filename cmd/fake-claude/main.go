// Command fake-claude plays the Claude CLI's wire protocol for the
...
// claude.Adapter already sets on every child process it spawns (see
// internal/adapters/providers/claude). It shares its entire fixture behavior
